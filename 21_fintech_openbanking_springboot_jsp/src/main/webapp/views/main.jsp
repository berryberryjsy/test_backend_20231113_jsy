...
// 				 data:{"user_seq_no":"사용자번호"}
				...
				success:function(data){
					...
					var res_list=data.res_list; //나의 계좌 목록 저장
			...
			$.ajax({
				...
				success:function(data){
					...
					box.find(".balance_amt").html(
						...
						+"<p><button onclick='transactionList(\""+fintech_use_num+"\",this)'>거래내역 조회</button></p>"
		...
		function transactionList(fintech_use_num, btnEle){
			$.ajax({
				...
				data:{"fintech_use_num":fintech_use_num},
				dataType:"json",
				success:function(data){ //data : 응답결과를 받을 변수
					console.log(data.res_list);
				 	var list="<ul>";
				 	//data.res_list --> 배열 
		...
		//계좌 등록하기(센터인증 이용기관용 : 사용자 인증후에 계좌 등록 가능)
		function addAccount(){
         ...
         <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
               <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                  ...
                  <li class="nav-item"><a class="nav-link" href="#!" onclick="myInfo()">나의정보1</a></li>
